    ...
    <div className="relative flex h-screen overflow-hidden bg-transparent" style={themeVars}>
      ...
      {showButton && (
        <button
          ...
          className="fixed left-4 top-8 z-50 flex h-11 w-11 items-center justify-center rounded-xl bg-card/90 shadow-[0_8px_40px_rgba(0,0,0,0.1)] md:hidden"
      ...
      {showButton && (
        <button
          ...
          className="fixed right-4 top-8 z-50 flex h-11 w-11 items-center justify-center rounded-xl bg-sidebar/90 text-sidebar-foreground shadow-[0_8px_40px_rgba(0,0,0,0.12)] transition-colors hover:bg-sidebar md:flex"
